...
{
	this->type_covariance = "diagonal";
	this->dimension_data = 0;
	this->number_gaussian_components = 0;
}
...
void Gaussian_Mixture_Model::SetParameter(string type_covariance, int dimension_data, int number_gaussian_components)
{
	this->type_covariance = type_covariance;
	this->dimension_data = dimension_data;
	this->number_gaussian_components = number_gaussian_components;
